...
The transportation authority's FOC implies that the marginal social benefit of transit investment depends on ridership, which in turn depends on the density of residents and jobs near the corridor. If zoning suppresses that station-area density, the model predicts a lower equilibrium return to transit investment. I test this mechanism directly at the tract level within DFW, using the interaction between the Baum-Snow and Han housing supply elasticity and DART proximity. The key prediction is not that more permissive zoning produces universally higher density---equilibrium sorting confounds this relationship in a cross-section---but that more permissive zoning should amplify the density that concentrates near transit nodes, since transit access and residential density are complements in the model's agglomeration mechanism.
...
& Pop., bivar. & Pop., ctrl. & Pop., 0.5\,mi & Units, 0.5\,mi & Pop., 1\,mi \\
\midrule
$\hat\gamma_i$
...
Taken at face value, the positive and significant $\hat\beta_3$ is consistent with the model's density channel: restrictive zoning limits the station-area density concentration that would otherwise generate the ridership base for transit investment. The equilibrium confound in $\hat\beta_1$ underscores why this test cannot claim causal identification---a pre-determined or exogenous zoning measure, or a panel design exploiting the timing of transit openings, would be needed to establish the direction of causality. These results nonetheless provide within-DFW equilibrium support for the mechanism: the degree to which transit proximity is associated with elevated density is lower in more restrictively zoned tracts, consistent with the transportation authority's FOC.

\subsection{Summary}

Proposition 1, from the municipal zoning FOC, is strongly supported within DFW: DART-adjacent tracts are significantly more restrictively zoned, consistent with the model's transit-pressure channel. Proposition 2, from the transportation authority's FOC, is tested at the tract level using the interaction between Baum-Snow and Han housing supply elasticity and DART proximity. The direct elasticity-density relationship is confounded by equilibrium sorting, but the interaction term is positive and significant across all buffer definitions and outcome measures: near DART, more permissive tracts achieve a substantially larger density concentration than more restrictive tracts, consistent with the model's prediction that restrictive zoning limits the station-area density base that determines transit investment returns. A credible causal test would require a pre-determined or exogenous zoning measure, or a panel exploiting the timing of transit openings; the present cross-sectional results provide equilibrium discipline for the mechanism rather than a causal estimate.
