...
\begin{align}
    ...
    \Phi \equiv \sum_{i'}\sum_{j'} T_{i'} E_{j'}\,\tilde{V}_{i'j'}^{\epsilon},
\end{align}
...
Each municipality $g \in G$ chooses the land-use allocation $\{\bar{H}_i^R, \bar{H}_i^F\}_{i \in S^g}$ to maximize the welfare of its incumbent residents. Following the political economy of local land use, municipal governments are disproportionately responsive to incumbent landowners, who benefit from rental income but bear the costs of local congestion and worker influx. Formally, municipality $g$ solves
\[
\max_{\{\bar{H}_i^R\}_{i \in S^g}}\;
\sum_{i \in S^g}
\Bigl[q_i^R \bar{H}_i^R + q_i^F \bar{H}_i^F - \phi(N_i, L_i)\Bigr]
\]
subject to $\bar{H}_i^R + \bar{H}_i^F = \bar{H}_i$ for each $i \in S^g$, taking other municipalities' allocations $\{\bar{H}_{i'}^R, \bar{H}_{i'}^F\}_{i' \notin S^g}$ and transportation investment $\{I_{jk}\}$ as given.

Substituting $\bar{H}_i^F = \bar{H}_i - \bar{H}_i^R$ and differentiating with respect to $\bar{H}_i^R$, the interior first-order condition at location $i \in S^g$ is
\begin{align}
\underbrace{\frac{\partial\bigl(q_i^R \bar{H}_i^R\bigr)}{\partial \bar{H}_i^R}
- \frac{\partial\phi}{\partial N_i}\frac{\partial N_i}{\partial \bar{H}_i^R}}_{\text{net marginal value of residential}}
=
\underbrace{\frac{\partial\bigl(q_i^F \bar{H}_i^F\bigr)}{\partial \bar{H}_i^F}
- \frac{\partial\phi}{\partial L_i}\frac{\partial L_i}{\partial \bar{H}_i^F}}_{\text{net marginal value of commercial}}.
\end{align}
The municipality equates the net marginal return to allocating the last unit of land to residential versus commercial use. Both disutility terms work in the direction of restriction: incumbents dislike additional residents (raising $N_i$) and additional workers (raising $L_i$), depressing the optimal capacity on both margins relative to a planner who does not place weight on $\phi$.
