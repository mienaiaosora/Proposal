...
\title{Proposal for Second Year Paper}
\author{Ke Jiang}
\date{}
...
U.S cities on average show lower transit infrastructure, \cite{Freemark2023-jh} reported that even the transit length and ridership are growing globally, the Unitied States seems to be stagnated since 1980s. Putting aside China, whom contribute to 40\% of total metro length, by 2023 the total metro length of United States was surpassed by India and nearly half of EU(fig\ref{metro lines global}). Even incorporating light rails or streetcars, which U.S cities put more focus on, the construction of transit still declines since 1970s and struggles to catch up the population growth. Reasons behind this can be puzzling but nontrivial. Transportation infrastructures are often endogeneous, it serces as a tool to boost economic development by reducing spatial frictions but can also be distorted\citep{Donaldson2025-wa}. In particular, policymakers may intentionally build the infrastructure to boost economics, or they may choose not to build if it's too expensive compared to returns. In general they are involved in scenario where they evaluate the returns and costs of new infrastructure. Standard evalutaion of the returns to transportation infrastructure invloves measuring the travel time saved or more distributional effect\citep{Fogel1964-pu,Tsivanidis2023-hs,Severen2021-oi}. Both \textcite{Tsivanidis2023-hs} and \textcite{Severen2021-oi} find that the returns to new transit infrastructure are lower than expected, and even negative from \textcite{Severen2021-oi}, due to the limited housing supply near stations. \textcite{Severen2021-oi} also pointed out the despersed workplaces and polycentric city structure as another reason for the low return to transit.  In summary restrictive zoning can limit the housing supply response to transit investment, which in turn potentially discourage transit investment. 

However,literature on estimating transportation infrasructure often take these housing-supply restrictions as given, wheras in realty, aside from certain geographic constraints, such restrictions are often the result of local zoning policies. Zoning is often politically supported by incumbent residents because it protects neighborhood quality and property values. In particular, restrictive zoning can limit housing supply,which protects local property values, reduces congestion in local public goods and amenities, and preserves environmental quality and neighborhood character\citep{Rollet2025-mk}.
However, these local benefits may come at broader citywide costs. In particular, restrictive zoning reduces the elasticity of housing supply in desirable locations\citep{Glaeser2002-vq}, and land-use regulationg pushes forward job-housing separation, raises commuting costs, and contributes to urban sprawl\citep{Glaeser2003-sr}. But the low-density city layout can also lower the economic return to public transit and discourage investment in public transit. Lower transit investment can turn into more car-oriented commuting, which further decentralize the city\citep{Baum-Snow2007-zj}. Such decentraliztion and car-dominance in turn reinforce the demand for low-density city and therefore the zoning regulations. This self-enforcing pattern can be a key driver of urban sprawl, and may help explain the stagnation of transit infrastructure in U.S cities.    

This self-reinforcing pattern between restrictive zoning and low transit investment can be particularly problematic in the context of U.S cities. On the one hand, low-density sprawl requires more road infrastructures per capita, the cost and maintenance fees may not be sustainable\citep{Brueckner2000-vd}. On the other hand, the car-denpendence and long commuting distance can increases congestion which are not internalized by households. Moreover, the low transit investment can also limit the accessibility of low-income households to job opportunities, which can exacerbate economic inequality\citep{Glaeser2008-xq}.

In summary, the discussion points to a broder but maybe underexplored problem: the full effect of zoning could be potentially more than what we currently understand, if we consider its effect on endogeneous transit investment decisions. In particular, this proposal aims to explore the following questions: First, how does local zoning affect metropolitan transportation investment decisions? Second, what are the welfare implications of this interaction, and how much inefficiency can be mitigated compared to a socially optimal benchmark where zoning and transportation are coordinated?
...
For now I tried to think of a model where municipalities and transportation authority make decisions sequentially, with municipalities choosing zoning first and the transportation authority responding with infrastructure investment. This captures the idea that zoning decisions are often more entrenched and harder to change than transportation investments, which can be adjusted more frequently. However, I am open to alternative specifications where the timing of decisions may differ. 
